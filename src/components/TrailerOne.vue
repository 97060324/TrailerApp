<template>
    <div class="TrailerHead">
        <div @click="$store.commit('view', undefined)" class="TrailerHead-back" to="/">
...
export default {
    ...
    mounted() {
        Vue.axios.get('https://api.npoint.io/ec0b1a8c5cefd2debd47')
            .then((resp) => {
                this.trailers = resp.data.trailerone;
            })
    },
}
</script>